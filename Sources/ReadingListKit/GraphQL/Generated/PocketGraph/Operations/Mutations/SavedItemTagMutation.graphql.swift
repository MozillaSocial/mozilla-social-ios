...
extension PocketGraph {
  class SavedItemTagMutation: GraphQLMutation {
    static let operationName: String = "SavedItemTag"
    ...
    struct Data: PocketGraph.SelectionSet {
      ...
      var savedItemTag: SavedItemTag? { __data["savedItemTag"] }

      /// SavedItemTag
      ///
      /// Parent Type: `SavedItem`
      struct SavedItemTag: PocketGraph.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        struct Item: PocketGraph.SelectionSet {
          ...
          struct AsItem: PocketGraph.InlineFragment, ApolloAPI.CompositeInlineFragment {
            ...
            typealias RootEntityType = SavedItemTagMutation.Data.SavedItemTag.Item
            ...
            struct Marticle: PocketGraph.SelectionSet {
              ...
              struct AsMarticleText: PocketGraph.InlineFragment, ApolloAPI.CompositeInlineFragment {
                ...
                typealias RootEntityType = SavedItemTagMutation.Data.SavedItemTag.Item.AsItem.Marticle
